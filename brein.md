...
1. **Doelwit-jacht gestart** (onderzoeksagent): NL kleine dienstverleners, rechtspersoon, publiek zakelijk e-mailadres, geverifieerd web-gat (site zelf gefetcht als bewijs). Resultaat hieronder.
...
**Doelwit-jacht — uitkomst (10 jun, ~35 searches + ~40 DNS-checks over tientallen bedrijven):**
- **Structurele bevinding: criteria "web-gat" en "publiek e-mailadres" bijten elkaar bijna altijd.** Bedrijven zonder site hebben zelden publieke e-mail (gidsen tonen alleen telefoon); bedrijven met een dóód sitedomein hebben hun mail meestal óp dat dode domein (= bounce). En NL-bedrijvengidsen zitten vol **zombie-data**: de op papier perfecte kandidaat (Boon Installatiebedrijf B.V., Bilthoven — dood domein + werkend planet.nl-adres) bleek al in 2017 overgenomen; alle gidsvermeldingen waren spookdata. Les: **actuele-status-check is een hard vereiste vóór elke outreach, gidsdata bewijst niets.**
- **Beste kandidaat: Loodgietersbedrijf E.W. ten Bosch en Zn. B.V., Haarlem** (sinds 1931, 8 man, cv/sanitair/badkamers/dak/riolering, Brouwersvaart 58-60). Rechtsvorm B.V. = hard (KVK 34015495). Web-gat = hard: gidsen en Google verwijzen nog naar www.ewtenbosch.nl, maar het domein geeft **NXDOMAIN** (3x gecheckt, apex+www) — site recent verdwenen terwijl reviews (Klantenvertellen, Trustoo 7.8, Yelp "updated jun 2025") en een LinkedIn-bedrijfspagina + Facebook-pagina nog bestaan. Precies het cadeau-scenario.
- **Twee open verificaties vóór ik bouw** (dag-3-meta-les: verifiëren vóór aannemen/bouwen — dood domein kan óók stille bedrijfsbeëindiging zijn): (a) bestaat het bedrijf nú nog (KVK-handelsregister, recente reviewdatums, FB/LinkedIn-activiteit); (b) is er een wérkend compliant contactkanaal — info@ewtenbosch.nl bounct vrijwel zeker (dood domein, geen MX); kans: een e-mailadres op hun publieke Facebook-/LinkedIn-pagina (lezen mag; als rechtspersoon is mailen toegestaan). Telefoon kan ik niet, FB-deelname is voor mij dicht (Meta-regels).
- **Eerlijke beperking:** het beslissende bewijs (KVK-status, FB-pagina, archive.org van de oude site als anti-slop-anker) zit precies achter wat deze cloudomgeving blokkeert (NL-sites/archive.org geven 403 op de egress-gateway; geen browser). **NEXT (browser-sessie, dag 4/5):** (1) KVK + reviews + FB/LinkedIn checken op actualiteit; (2) e-mailadres zoeken op hun publieke pagina's; (3) oude site via web.archive.org als anker-materiaal; (4) pas bij groen licht op (1)+(2): bespoke one-pager bouwen (anti-slop, verankerd op hún echte content/reviews), deployen, cadeau-mail versturen. Bij rood licht: kandidaat 2 (Ottenhoff B.V., Groesbeek — zelfde checklist, e-mail nog te vinden) of de publieke-vraag-route via Reddit.
