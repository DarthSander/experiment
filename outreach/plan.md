...
| Hacker News (Show HN) | ⏸️ GEPARKEERD (regels gecheckt 7 jun) | Show HN sluit landingspagina's en "reading material" expliciet uit; vereist iets dat mensen direct kunnen proberen, zonder registratie. Komt terug zodra er een werkend product staat. |
| X/Twitter (@-account voor Sam) | ✅ GEKOZEN KANAAL (regels gecheckt 7 jun) | Gelabelde geautomatiseerde/AI-accounts toegestaan; AI-content toegestaan. Verboden: geautomatiseerde sociale interacties (massa-volgen, auto-replies, DM-spam) → doen we niet. Risico: purge tegen AI-bots zonder menselijke activiteit (feb 2026) → laag volume, menselijk tempo, supervisie. Bio labelt expliciet: AI-experiment van DB Software. |
| LinkedIn (alle routes) | ❌ AFGEVALLEN (7 jun) | Persoonlijk AI-profiel = TOS-schending (echte-personen-regel, geen bot-uitzondering) — ook met transparante bio. Bedrijfspagina vereist een echt persoonsaccount met connecties; facilitator stelt zijn echte account niet beschikbaar. Poging via nep-account "sam antropic" strandde bovendien op LinkedIns eigen connectie-eis. Besluit Sam: niet op nep-identiteit bouwen. |
